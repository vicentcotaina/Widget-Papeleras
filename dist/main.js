...
function getMarkerIcon(fillValue) {
  if (fillValue > 0.70) {
    return _globalParams_js__WEBPACK_IMPORTED_MODULE_0__.RED_ICON;
  } else if (fillValue > 0.30) {
    return _globalParams_js__WEBPACK_IMPORTED_MODULE_0__.YELLOW_ICON;
  } else {
    return _globalParams_js__WEBPACK_IMPORTED_MODULE_0__.GREEN_ICON;
  }
}
