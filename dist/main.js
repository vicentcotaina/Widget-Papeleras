...
/* harmony export */   "getMarkerIcon": () => (/* binding */ getMarkerIcon),
/* harmony export */   "updateGeneralViewData": () => (/* binding */ updateGeneralViewData)
/* harmony export */ });
/* harmony import */ var _globalParams__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./globalParams */ "./src/js/globalParams.js");
...
function geolocate(data, initMapFunction, createMarkerFunction) {
  ...
  navigator.geolocation.watchPosition(
      (marker) => {
        if (firstTime) {
          map = initMapFunction(_globalParams__WEBPACK_IMPORTED_MODULE_0__.LATITUDE_VALENCIA, _globalParams__WEBPACK_IMPORTED_MODULE_0__.LONGITUDE_VALENCIA);
          firstTime = false;
        }
...
function getMarkerIcon(fillValue) {
  if (fillValue > 0.70) {
    return _globalParams__WEBPACK_IMPORTED_MODULE_0__.RED_ICON;
  } else if (fillValue > 0.30) {
    return _globalParams__WEBPACK_IMPORTED_MODULE_0__.YELLOW_ICON;
  } else {
    return _globalParams__WEBPACK_IMPORTED_MODULE_0__.GREEN_ICON;
  }
}
...
/* harmony import */ var _bussinesLogic_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bussinesLogic.js */ "./src/js/bussinesLogic.js");
...
// GLOBAL VARIABLES
const realtimeData = await (0,_bussinesLogic_js__WEBPACK_IMPORTED_MODULE_1__.getDataFromAPI)(_globalParams_js__WEBPACK_IMPORTED_MODULE_0__.URL_BASE_API + 'getRealtime');
...
generalViewButton.addEventListener('click', (event) => {
  ...
  (0,_bussinesLogic_js__WEBPACK_IMPORTED_MODULE_1__.updateGeneralViewData)(realtimeData, setFillValueGraph, initMap, createMarker);
});
...
selectSensor.addEventListener('change', async (event) => {
  if (event.target.value) {
    ...
    const data = await (0,_bussinesLogic_js__WEBPACK_IMPORTED_MODULE_1__.getDataFromAPI)(_globalParams_js__WEBPACK_IMPORTED_MODULE_0__.URL_BASE_API + `${event.target.value}`);
...
function createMarker(map, data) {
  ...
  {
    icon: (0,_bussinesLogic_js__WEBPACK_IMPORTED_MODULE_1__.getMarkerIcon)(data.fillingLevel),
